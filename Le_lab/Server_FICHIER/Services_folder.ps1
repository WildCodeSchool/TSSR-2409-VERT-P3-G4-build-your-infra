# Variables
$racinePartageServices = "C:\Partage\Services"  # Chemin racine pour les services
$ouDepartements = "OU=Departments,DC=Pharmgreen,DC=com"  # OU contenant les départements
