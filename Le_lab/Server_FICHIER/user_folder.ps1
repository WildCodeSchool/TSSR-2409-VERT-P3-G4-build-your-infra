# Variables
$racinePartageUtilisateurs = "C:\Partage\Utilisateurs"  # Chemin de stockage des dossiers des utilisateurs
$searchBase = "OU=Utilisateurs,DC=Pharmgreen,DC=com"  # Changez pour l'OU où se trouvent vos utilisateurs
